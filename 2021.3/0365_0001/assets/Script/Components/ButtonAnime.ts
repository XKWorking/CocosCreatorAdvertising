import { AnimeLine } from "../Panel/FrameAnime"
                ...
                animeLine
                    .anime(() => {
                        return AnimeLine.create(this.node)
                            .anime(this.shakeOptions.time / 4, { angle: this.shakeOptions.min })
                            .anime(this.shakeOptions.time / 2, { angle: this.shakeOptions.max })
                            .anime(this.shakeOptions.time / 4, { angle: 0 })
