...
export default class CpSDK {
    ...
    public static _Version = "Cool Playable SDK Version: 1.0.1" as const;
    ...
    //section 必须是1-10的整数
    public static ClickContent(area: number, remark?: string) {
        try {
            Yeah.clickContent(this._nowSection, area, remark);
        } catch (e) {
            console.log("%c【CoolplayableSDK】ClickContent:(section" + this._nowSection + ", area" + area + ', remark:' + remark + ")", "background: rgb(255, 255, 0); color: rgb(0, 0, 0)");

        }
    }
    public static ClickFinishContent(area: number, remark?: string) {
        try {
            Yeah.clickFinishContent(this._nowSection, area, remark);
        } catch (e) {
            console.log("%c【CoolplayableSDK】ClickFinishContent:(section" + this._nowSection + ", area" + area + ', remark:' + remark + ")", "background: rgb(255, 255, 0); color: rgb(0, 0, 0)");
        }
    }
    public static ClickDownloadBar(area: number, remark?: string) {
        try {
            ...
            console.log("%c【CoolplayableSDK】ClickDownloadBar:(section" + this._nowSection + ", area" + area + ', remark:' + remark + ")", "background: rgb(255, 255, 0); color: rgb(0, 0, 0)");
        }
        this.GotoAppStore();
    }
    public static ClickFinishDownloadBar(area: number, remark?: string) {
        try {
            Yeah.clickFinishDownloadBar(this._nowSection, area, remark);
        } catch (e) {
            console.log("%c【CoolplayableSDK】ClickFinishDownloadBar:(section" + this._nowSection + ", area" + area + ', remark:' + remark + "))", "background: rgb(255, 255, 0); color: rgb(0, 0, 0)");
        }
        this.GotoAppStore();
    }
    ...
    public static EnterSection(section: number, remark?: string) {
        if (section > this._nowSection) {
            this._nowSection = section;
            try {
                Yeah.enterSection(section, remark);
            } catch (e) {
                console.log("%c【CoolplayableSDK】EnterSection:(section:" + this._nowSection + ', remark:' + remark + ")", "background: rgb(0, 255, 255); color: rgb(0, 0, 0)");
            }
        }
    }
...
declare module Yeah {
    ...
    function clickContent(section: number, area: number, remark?: string);
    function clickFinishContent(section: number, area: number, remark?: string);
    function clickDownloadBar(section: number, area: number, remark?: string);
    function clickFinishDownloadBar(section: number, area: number, remark?: string);
    function clickArea(section: number, area: number, remark?: string);
    function clickReborn(section: number, area: number, remark?: string);

    function enterSection(section: number, remark?: string);
