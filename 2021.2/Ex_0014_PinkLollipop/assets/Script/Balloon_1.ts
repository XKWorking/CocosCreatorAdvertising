...
@ccclass
export default class Balloon_1 extends cc.Component {
    ...
    onTouchStart(e: cc.Event.EventTouch) {
        ...
        this.reduceHp();
        if (LayerManger.Instance.GetLayer(Layer_1).getLevelNum() == 1) {
    ...
    gameOver() {
        LayerManger.Instance.GetLayer(Layer_1).addGoldScore(66);
        LayerManger.Instance.GetLayer(Layer_1).reduceEnemyNum(1);
