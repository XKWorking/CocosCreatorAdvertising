...
@ccclass
export default class Balloon_2 extends cc.Component {
    ...
    gameOver() {
        LayerManger.Instance.GetLayer(Layer_1).addGoldScore(88);
        LayerManger.Instance.GetLayer(Layer_1).reduceEnemyNum(2);
