...
@ccclass
export default class FukubukuroMove extends cc.Component {
    ...
    onCollisionEnter(other: cc.Collider, self: cc.Collider) {
                    ...
                    if (other.node.name === this._objParent.children[nextIndex].name) {
                        cc.tween(this.node)
                            ...
                            .call(() => {
                                ...
                                this._objParent.children[nextIndex].getComponent(RedPacketMove).createRippleExplode(this._fxParent, this.node.getPosition());
                                LayerManger.Instance.GetLayer(Layer_1).JudgePlayerObjNum();
                            })
                            .start();
                    }
        ...
        } else if (other.node.group === 'redLine') {
