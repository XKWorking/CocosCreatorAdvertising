...
export default class FictionScrollView extends cc.Component {
    ...
    start() {
        this._spotHeight_1 = Math.floor(this.moveFiction.y) + 1280;
        this._spotHeight_2 = this._spotHeight_1 + 2400;
    }
    ...
    public StartMove() {
        ...
        this.bookGuidFinger.active = true;
        let pos = LayerManger.Instance.GetLayer(Layer_1).ChangePos(this.bookGuidFinger, this.fingerBeginPos);
        this.bookGuidFinger.position = pos;
        let t = cc.tween;
