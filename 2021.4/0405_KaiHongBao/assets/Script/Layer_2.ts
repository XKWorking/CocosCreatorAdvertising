...
export default class Layer_2 extends PopupPanel {
    ...
    protected start() {
        ...
        this.btn_DownLoad_1.on("click", () => {
            ...
            CpSDK.ClickFinishDownloadBar(2, "结束页面立即下载领取按钮");
        }, this);
        this.btn_DownLoad_2.on("click", () => {
            AudioManager.play('button');
            CpSDK.ClickFinishDownloadBar(3, "结束页面下载APP领取按钮");
        }, this);
        this.ShowSlef();
        this.ShowScore();
    ...
    private ShowFinger() {
        this.finger.parent = this.btn_DownLoad_1.parent;
        this.finger.setPosition(cc.v2(128, -313));
        cc.tween(this.node)
            .delay(1)
            .call(() => {
